...
type ReceiptPublicAccessGateProps = {
  code: string;
  clientFirstName: string;
};

/**
 * Gate visual igual ao do orçamento — familiaridade para o cliente.
 */
export default function ReceiptPublicAccessGate({
  code,
  clientFirstName,
}: ReceiptPublicAccessGateProps) {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    setBusy(true);
    try {
      const response = await fetch(`/api/r/${encodeURIComponent(code)}/unlock`, {
        method: "POST",
