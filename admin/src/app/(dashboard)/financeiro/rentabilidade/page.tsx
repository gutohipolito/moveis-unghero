...
export default async function RentabilidadePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <InfoTooltip label="Como calculamos a rentabilidade">
          ...
          <ul className="space-y-1.5 text-[11px] leading-relaxed text-slate-600">
            <li>
              <strong className="text-slate-700">Receita</strong> = valor do orçamento aprovado (ou o
              previsto, quando não há aprovado — sinalizado na linha).
            </li>
            <li>
              <strong className="text-slate-700">Custo</strong> = despesas vinculadas à obra em Contas
              a Pagar (ignorando canceladas).
            </li>
            <li>
