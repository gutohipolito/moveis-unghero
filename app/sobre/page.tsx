    ...
    <div className={styles.page}>
      <div className={styles.frame}>
        ...
        <div className={styles.prose}>
          <p>
            Preferimos residências completas e espaços comerciais com identidade clara a espalhar a
            capacidade em cômodos isolados.
          </p>
          <p>
            Do desenho técnico à montagem, o trabalho passa pela nossa oficina. Materiais e
            ferragens escolhidos para durar; prazo alinhado com honestidade na primeira conversa.
          </p>
          <p>
